...
describe('ThreadRepositoryPostgres', () => {
  ...
  describe('validateAvailableThread function', () => {
    it('should throw NotFoundError when thread not found', async () => {
      ...
      // Action & Assert
      await expect(threadRepositoryPostgres.validateAvailableThread(threadId)).rejects.toThrow(NotFoundError);
    });
    it('should not throw NotFoundError when thread found', async () => {
      ...
      const threadRepositoryPostgres = new ThreadRepositoryPostgres(pool, {});
      // Action & Assert
      await expect(threadRepositoryPostgres.validateAvailableThread(threadId)).resolves.not.toThrow(NotFoundError);
    });
